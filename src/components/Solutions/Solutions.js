            ...
            <div className="w-full md:w-1/2 p-8 flex flex-col justify-center">
                <ul className="space-y-8 md:space-y-10">
                    <li className="flex flex-col md:flex-row items-center transition-transform duration-300 hover:translate-x-2">
                        ...
                        <div className="flex-1">
                            <Link to="/seo" className="no-underline">
                                <h2 className="text-2xl md:text-3xl font-bold mb-1 text-[#272D4E]">Référencement naturel (SEO)</h2>
                    ...
                    <li className="flex flex-col md:flex-row items-center transition-transform duration-300 hover:translate-x-2">
                        ...
                        <div className="flex-1">
                            <Link to="/training" className="no-underline">
                                <h2 className="text-2xl md:text-3xl font-bold mb-1 text-[#272D4E]">Formation</h2>
                    ...
                    <li className="flex flex-col md:flex-row items-center transition-transform duration-300 hover:translate-x-2">
                        ...
                        <div className="flex-1">
                            <Link to="/sea" className="no-underline">
                                <h2 className="text-2xl md:text-3xl font-bold mb-1 text-[#272D4E]">Référencement SEA</h2>
                    ...
                    <li className="flex flex-col md:flex-row items-center transition-transform duration-300 hover:translate-x-2">
                        ...
                        <div className="flex-1">
                            <Link to="/web-development" className="no-underline">
                                <h2 className="text-2xl md:text-3xl font-bold mb-1 text-[#272D4E]">Développement Web et Mobile</h2>
