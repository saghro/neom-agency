    ...
    import personPlaceholder from '../../images/personwebdev1.png'; // Adjust the path as necessary
    import './button.css'
    const Hero = () => {
    return (
        <div
  ...
  <h1 className="text-4xl lg:text-8xl font-bold mb-4">Développement Web et Mobile</h1>
