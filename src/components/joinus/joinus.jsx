...
<div className='shadow drop-shadow-lg mt-12 flex flex-row border h-24 bg-white text-black'>
  <input className='bg-white border border-gray-400 px-5 mt-6 mb-6 ml-28 text-black align-center mb-2 rounded-lg' placeholder='Poste, mots clés' type="text" />
  <input className='bg-white border-gray-400 border px-5 mt-6 mb-6 ml-28 rounded-lg' placeholder='Localisation' type="text" />
...
<p className='text-[#2e1065]'><span className='font-bold'>Équipements, services, financement, reconditionnement </span> – ajoutés à toute </p>
<p className='text-[#2e1065]'>l’expertise de la coordination opérationnelle des projets accumulée depuis </p>
<p className='text-[#2e1065]'>50 ans, Econocom s’impose comme le partenaire privilégié des </p>
<p className='text-[#2e1065]'>organisations qui veulent se renforcer dans un monde en profonde transformation. </p>
</div>
</div>
<div className='flex justify-between'>
<div className='text-left ml-16'>
<p className='text-4xl font-bold text-[#2e1065] mb-6 mt-24'>Se former, évoluer, grandir</p>
<p className='text-3xl font-bold font-montserrat text-[#a955f3] -mt-4 mb-6 '>dans les technologies informatiques</p>
<p className=' text-[#2e1065]'>Chez Econocom, la prise de responsabilité est encouragée et reconnue. A</p>
...
<div className='h-32 flex items-center justify-center'>
    <div className='flex justify-center mt-4 space-x-8'>
        <a href="https://linkedin.com"><FaLinkedinIn className='text-xl cursor-pointer' /></a>
        <a href="https://facebook.com"><FaFacebook className=' text-xl cursor-pointer' /></a>
        <a href="https://instagram.com"><FaInstagram  className=' text-xl cursor-pointer' /></a>
        <a href="https://youtube.com"><FaYoutube className='text-xl cursor-pointer'  /></a>
    </div>
</div>
<div className='flex justify-between'>
