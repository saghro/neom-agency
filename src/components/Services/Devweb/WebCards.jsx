...
const WebCards = () => {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center my-8">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10"> {/* Changed gap-6 to gap-8 */}
        <Card
          title="UI/UX design"
        ...
        <Card
          ...
          description="Correction des bugs, mise à jour de nouvelles fonctionnalités, et surveillance de la sécurité."
          icon={<FaCog />}
        />
        <Card
          title="Déploiement"
