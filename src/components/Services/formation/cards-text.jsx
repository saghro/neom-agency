...
import "./styles.css"; // Make sure to import the custom CSS file

const Media = () => {
  return (
    <>
      <div className="flex flex-col justify-center items-center px-8 mt-8 mb-6">
        <h1 className="text-3xl bg-gradient-to-r from-[#C7A2CB] via-[#6A71B3] to-[#6A71B3] text-transparent bg-clip-text font-bold font-Rammetto-One text-center">
      ...
      <div className="flex flex-col md:flex-row justify-between w-full -mt-48 space-y-6 md:space-y-0 md:space-x-4">
        <div className="px-36 py-32 rounded-3xl border ml-4 bg-gradient-to-r from-[#6A71B3] to-[#A8D9E0]">
          <img src={image1} alt="" />
        </div>
        <div className="px-36 py-32 rounded-3xl border ml-4 bg-gradient-to-r from-[#6A71B3] to-[#C7A2CB]">
          <img src={image2} alt="" />
        </div>
        <div className="px-36 py-32 rounded-3xl border mr-12 bg-gradient-to-r from-[#A8D9E0] to-[#C7A2CB]">
          <img src={image3} alt="" />
        </div>
      </div>
    </>
