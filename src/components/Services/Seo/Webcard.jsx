...
const WebCards = () => {
  const Cards = ({ title, description, icon }) => {
    return (
      <div className="max-w-sm rounded overflow-hidden shadow-lg p-6 bg-white transform transition duration-300 hover:bg-[#FFA288] hover:text-white flex flex-col justify-between">
        <div>
        ...
        <button className="mt-4 px-4 py-2 bg-[#FFA288] border-2 border-white text-white rounded-full hover:bg-white hover:text-[#F19F00] transition duration-300.">
          Savoir Plus
        </button>
      </div>
    );
