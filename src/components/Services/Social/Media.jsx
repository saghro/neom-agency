  ...
  return (
    <div className="flex flex-col justify-center items-center px-8 mt-8 ">
      <h1 className="text-3xl font-bold font-Rammetto-One text-[#7854F7] text-center">
        Booster votre présence en ligne grâce à nos services et notre expertise en marketing digital et en marketing de contenu...
      </h1>
      <h1 className="text-3xl font-bold font-Rammetto-One text-[#248AD4] mt-8 text-center">
        Découvrez le potentiel des médias sociaux et transformer les interactions en résultats concrets
      </h1>
