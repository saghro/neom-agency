    ...
    return (
        <div className='flex flex-col md:flex-row justify-between items-center mb-6'>
            <div className='text-center md:text-left mb-6 md:mb-9 md:ml-8'>
                ...
                <p className='font-bold md:ml-12 mr-24 text-3xl md:text-4xl'> le monde de <span className='text-[#ff997f]'>digital</span> ?</p>
                ...
                <p className='font-regular md:ml-12 text-lg md:text-xl'>Demandez un devis dès aujourd'hui et profiter de nos services exceptionnels. </p>
